...
<body>
    ...
    <div class="modal fade" id="saranTingkat1" tabindex="-1" aria-labelledby="saranTingkat1Label" aria-hidden="true">
    ...
    <div class="modal fade" id="saranTingkat2" tabindex="-1" aria-labelledby="saranTingkat2Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="saranTingkat3" tabindex="-1" aria-labelledby="saranTingkat3Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
